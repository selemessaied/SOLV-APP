      ...
      <div className="flex flex-col gap-1">
        ...
        <div className="flex flex-col gap-1">
          ...
          <div className="w-[150px]">
            <Select
              options={typeOptions}
              onChange={(value) => onTypeChange(value, 'hint2Type')}
            />
          </div>
        ...
        {getValues().hint2Type === 'text' ? (
          <div className="flex flex-col gap-1">
            ...
            <div className="h-7 text-red-500">{errors.hint2Text?.message}</div>
          </div>
        ) : (
          <div className="flex flex-col gap-1">
            <label htmlFor="step" className="font-bold text-gray-600">
            ...
            <div className="h-7 text-red-500">{errors.hint2Media?.message}</div>
          </div>
        )}
        ...
        <div className="flex flex-col gap-1">
          ...
          <div className="w-[150px]">
            <Select
              options={typeOptions}
              onChange={(value) => onTypeChange(value, 'hint3Type')}
            />
          </div>
        ...
        {getValues().hint3Type === 'text' ? (
          <div className="flex flex-col gap-1">
            ...
            <div className="h-7 text-red-500">{errors.hint3Text?.message}</div>
          </div>
        ) : (
          <div className="flex flex-col gap-1">
            <label htmlFor="step" className="font-bold text-gray-600">
            ...
            <div className="h-7 text-red-500">{errors.hint3Media?.message}</div>
          </div>
        )}
        ...
        <div className="flex flex-col gap-1">
          ...
          <div className="w-[150px]">
            <Select
              options={typeOptions}
              onChange={(value) => onTypeChange(value, 'successMsgType')}
            />
          </div>
